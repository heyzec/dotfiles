self: super: {
  # bruno = super.bruno.overrideAttrs (finalAttrs: prevAttrs: rec {
  #
  #   npmDepsHash = "sha256-mqJnkFWy4C1xEOn1GBIWlhTcHQmoQFwviw589Fj7bWU=";
  #
  ...
  bruno = with self;
    buildNpmPackage rec {
      ...
      src = super.fetchFromGitHub {
        owner = "usebruno";
        repo = "bruno";
        rev = "b3ffc904ad168ea281224d0718331c3c7f52ffd0";
        hash = "sha256-Es+55ZQNGxcPfs1N7raGxWZ5m/7N/ASBMYH4X6jHMNQ=";

        postFetch = ''
          ${self.lib.getExe self.npm-lockfile-fix} $out/package-lock.json
        '';
      };
